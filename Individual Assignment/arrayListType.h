...
void arrayListType<elemType>::insert(const elemType& insertItem)
{
    ...
    {
        i = seqSearch(insertItem);
        if (i == -1) //the item to be inserted
...
template <class elemType>
void arrayListType<elemType>::printContact(int i) const
{
...
template <class elemType>
void arrayListType<elemType>::removeContact(string name)
{
    int i;
    i = contactSearch(name);
    if( i!=-1){
        removeAt(i);
        cout << endl;
        cout << name << " got removed from the contact book." << endl;
    }else{
        cout << endl;
        cout << "Unable to find and remove contact." << endl;
    }
